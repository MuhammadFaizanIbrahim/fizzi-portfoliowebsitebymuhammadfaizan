...
const Carousel = ({ slice }: CarouselProps): JSX.Element => {
  ...
  return (
    ...
    >
      <div className="background pointer-events-none absolute
       inset-0 bg-[#710523] opacity-50"/>

<WavyCircles className="absolute left-1/2 top-1/2 
h-[120vmin] -translate-x-1/2 -translate-y-1/2 text-[#710523]" />
    ...
    <View className="aspect-square h-[70vmin] min-h-40">
      ...
      flavor={FLAVORS[currentFlavorIndex].flavor} ref={sodaCanRef}/>
      </Center>
  ...
  return (
    <button
      ...
      className="size-12 rounded-full border-2 border-white
       bg-white/10 p-3 opacity-85 ring-white
